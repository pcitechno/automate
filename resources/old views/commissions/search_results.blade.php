...
<body>
    <div class="main-content">
        <div class="container">
            ...
            <table id="adj" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th class="head3" style="text-align: center; padding:13px">Benefits Name</th>
                            ...
                            <td colspan="7">
                                <table class="table table-bordered">
                                    <thead>
                                        ...
                                        @php
                                        // Add the current row's values to the totals
                                        $totalPayable += $detail['payable_amt'];
                                        $totalTds += $detail['tds_amt'];
                                        $totalFinal += $detail['final_amt'];
                                        @endphp 
                                            <tr>
                                                <td>{{ $detail['remark_3'] }}</td>
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($group['details'] as $detail)
                                          ...
                                          <tr>
                                                ...
                                                <td>{{ $detail['cir_no'] }}</td>
                                                <td>{{ $detail['net_payable_amount'] }}</td>
                                                <td>{{ $detail['tds_deduction'] }}</td>
                                                <td>{{ $detail['final_amount'] }}</td>
                                                <td>{{ $detail['date'] }}</td>
                                                <td id="bac5">{{ $detail['bank_name'] }}</td>
