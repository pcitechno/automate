    ...
    <div class="hero">
      <div class="hero-text">
        ...
        <p>
          ...
          <br>  <b>Automated Calculations: </b> Automate commission calculations to minimize errors and save time, allowing you to focus on growing your business.
      ...
      <img loading="lazy" class="img_axp" src="{{ asset('storage/images/bacground1.png') }}" alt="Illustration of Folder Management">
    </div>
  </main>
