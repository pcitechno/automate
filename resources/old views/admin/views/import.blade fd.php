...
<body>
    <div class="container">
        ...
        <table id="commissionTable">
            <thead>
                <tr>
                    <th scope="col">so_code</th>
                    <th scope="col">do</th>
                    <th scope="col">so_name</th>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            searchInput.addEventListener('input', function() {
                ...
                if (filter === '') {
                    table.style.display = 'none'; // Hide table if search is blank
                    noDataMessage.style.display = ''; // Show no data message
                    return; // Exit early
                }
