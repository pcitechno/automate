    ...
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="dropdown" style="margin-top: 20px;">
                <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="actionsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="actionsDropdown">
                    ...
                    <li>
                        <form action="{{ route('import-brokers') }}" method="POST" enctype="multipart/form-data" class="d-flex align-items-center px-3">
                            @csrf
                            <input type="file" name="file" class="form-control me-2" required style="width: 70%;">
