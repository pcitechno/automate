...
.dashboard-header {
    ...
    border-bottom-left-radius: 90px;
    border-bottom-right-radius: 90px;
    background: linear-gradient(90deg, #ff24a0,#ff24a0,#b4b000,#ff24a0,#ff24a0);
    box-shadow: 0 14px 20px rgba(0, 0, 0, 0.2);
}
...
<body>
    ...
    <div class="sidebar" style="background-color: #2c3e50; padding-left: 20px; padding-top: 2px; height: 100vh; color: white;">
        ...
        <h5 class="control-center-heading" style="margin-top: 40px">Quick Access</h5>
        <a href="/import-data" style="color: #ecf0f1; display: block; ">
        ...
        <!-- Dashboard Footer -->
        <footer class="dashboard-footer" style="padding-top:70%">
        ...
        <div class="d-flex">
            <div class="toast-body d-flex align-items-center">
                ...
                <span class="text-dark fs-5">
                    <strong>No Match Found!</strong> The broker you're searching for doesn't exist. Please try again with different criteria.
                </span>
            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="dynamicModalLabel">
                            <i class="fas fa-user-circle me-2"></i> Trainer Details
                        </h5>
            ...
            modalContent.innerHTML = `
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p style="background-color: #ecf0f1; color: black; padding-top:5px; border-radius: 5px;">
                        <strong>Broker Name:</strong> ${broker.broker_name}
                        </p>

                    </div>
                    <div class="col-md-6">
                        <p><strong>Preferred Code:</strong> ${broker.preffered_code}</p>
                         <p><strong>Aadhar No:</strong> ${broker.broker_id}</p>
