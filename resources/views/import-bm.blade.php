...
<body>
    ...
    <div class="container-fluid">
        ...
        <h2 style="color:white;">Import Final BM Commission</h2>

        <!-- Action Section -->
        <div class="action-row">
            <!-- Import Form -->
            <form action="{{ route('importBMCommission') }}" method="POST" enctype="multipart/form-data" class="d-flex">
                @csrf
        ...
        <h3>Total Number of Records: {{ $bmCommissions->count() }}</h3>
    </div>
