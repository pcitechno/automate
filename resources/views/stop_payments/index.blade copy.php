    ...
    <tbody>
        ...
        <tr>
                 ...
                 <form action="{{ route('stop-payments.destroy', $stopPayment->s_no) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="custom-gradient-button">Delete</button>
            ...
            <div class="modal-body">
                <form action="{{ route('stop-payments.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="brokerId" name="broker_id" required>
                    </div>
                    <div class="mb-3">
                        <label for="pefCode" class="form-label">PEF Code</label>
                        <input type="text" class="form-control" id="pefCode" name="pef_code" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="refNo" name="ref_no" required>
                    </div>
