...
.colorful-text {
    background: linear-gradient(90deg, #ea9f13f9, #e10358, #220377f9, #ef007b);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    font-size: 3em;
    font-weight: bold;
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1 class="colorful-text">BM-COMMISSION</h1>
            <div class="mb-3">
            ...
            <table id="commissionTable" class="table table-striped table-bordered" style="display: none;">
                ...
                <tbody>
                    ...
                    @foreach ($bmCommissions as $commission)
                        @php
                            $key = $commission->PAN . '|' . $commission->Trainer_ID . '|' . $commission->Code;
